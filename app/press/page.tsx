  ...
  return (
    <PageWrapper>
      ...
      <PageSection compact tinted>
        <div className="max-w-[95%] sm:max-w-[90%] mx-auto flex flex-col gap-8">
        ...
        <div className="max-w-[95%] sm:max-w-[90%] mx-auto flex flex-col gap-10 md:gap-[60px]">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
              {[
                {
                  label: 'Short version',
                  text: 'Logo.ai is an AI-powered logo generator launching May 2026. The platform creates professional, original logos in seconds — not templates. 1,000,000 free logos will be available at launch, no credit card required.',
                },
                {
                  label: 'Full version',
                  text: 'Logo.ai is an AI logo generator launching May 2026, founded by brothers Abhinav and Ashwin Reddy — serial founders with three decades of building products across web and mobile, multiple exits, and millions of users reached. The platform creates professional, original logos in seconds using AI trained on real design principles — color, typography, spacing, and hierarchy. Unlike traditional logo makers that recycle templates, Logo.ai generates unique designs tailored to each brand. The company is headquartered in San Francisco, with teams in Singapore, Tallinn, and Dubai. At launch, 1,000,000 free logos will be available in high-resolution PNG, SVG, JPG, and PDF formats.',
                },
              ].map((item) => (
                <div
                  key={item.label}
