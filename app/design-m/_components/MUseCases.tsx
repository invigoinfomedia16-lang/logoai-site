// MUseCases — v11 "Use Cases" section. Three groups (Your Digital
// Presence / Marketing & Sales / Physical & Print) with 4 cards each.
// Mirrors NUseCases visually; copy comes verbatim from the v11 doc.
...
export default function MUseCases() {
  return (
    <section
      id="use-cases"
