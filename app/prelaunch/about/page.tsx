// About — placeholder during prelaunch. Will be redesigned in the new
// MLp visual language; until then it renders the same nav as the main
// page and a "we're still building this" message. NOT the legacy
// m-theme About page (deleted from this branch's serve path so no old
// design leaks anywhere under /prelaunch).
...
export const metadata: Metadata = {
  title: 'About — LOGO.AI',
  description:
    'LOGO.AI — the world’s best AI logo generator, free at launch for the first 2,000,000 users.',
}
    ...
    <MLpSubpageShell>
      ...
      <main className="lp-placeholder">
        ...
        <h1 className="lp-placeholder-h1">
          About <span className="muted">LOGO.AI</span>
        </h1>
